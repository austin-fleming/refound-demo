...
export const LandingView: NextPage = () => {
	...
	return (
		<>
			<Grid container justifyContent="center" sm={8} style={{ margin: "0 auto" }}>
				<Grid item sm={12} md={8} style={{ padding: "5%", paddingTop: "2%" }}>
					...
					>
						<a
							href="/sign-up"
							className="bg-[#01A0B0] hover:bg-[#017984]"
							style={{ padding: "8px 35px", borderRadius: "5px", color: "white" }}
						>
							<div>Sign Up</div>
						</a>
						<a href="/learn-more">
			...
			<Grid item sm={12} md={4} style={{ paddingTop: "3%" }}>
				<img
					src="https://drive.google.com/uc?export=view&id=1EnP0CUBWuWRRXf2eTjuuWJ2mL7wjYqTK"
					style={{ width: "100%" }}
					alt="Refound iPhone Mockup"
				/>
			</Grid>
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 400 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												to capture live photos for NFTs. This helps store
												the meta data of time and place directly on the
												blockchain on IPFS and helping viewers and newsrooms
												know that the image is not altered or doctored.
											</Typography>
										</CardContent>
										<CardMedia
											component="img"
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 400 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												Ease of payment to journalists and their local
												sources, fixers, and contacts in war zones and
												conflict zones via stable coin using a an easy setup
												crypto wallet on Celo. Cryptocurrency provides a
												transfer of value that is much faster than banks,
												and much cheaper even in cases of international
												transfers. Account transactions are publicly
												auditable and secure, and easily accessible with a
												smartphone. 
											</Typography>
										</CardContent>
										<CardMedia
									...
									<Card sx={{ maxWidth: 600, height: 550 }}>
										<CardContent>
											<Typography
												...
												color="#01A0B0"
											>
												Decentralized content moderation and on-chain
												governance
											</Typography>
											<Typography variant="body2" color="text.secondary">
												  On chain governance is utilized for content
												moderation which promotes credibility in a
												decentralized manner. Centralized platforms try to
												moderate content with a one size fits all approach
												banning users and deleting posts that only a small
												subsection of users find offensive. However, Refound
												allows users to adjust content filters so that they
												don't see some content rather than removing it for
												everyone. Refound allows users to downvote content
												they view as being misinformation making it less
												likely to be shown to others. There is also an
												option to flag content which is then reviewed by
												community moderators to make a mulit-signatory
												decision as to its viability on the platform.
											</Typography>
										</CardContent>
										<CardMedia
											component="img"
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 550 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												Having a beneficiary wallet where proceeds can go to
												a chosen beneficiary or family member in case of
												journalist going MIA or their demise.
											</Typography>
										</CardContent>
										<CardMedia
											component="img"
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 450 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												The Refound subscriptions feature allows viewers to
												subscribe to any Refound journalist with their
												wallets and receive email notifications when new
												content is posted. For journalists, web3
												subscriptions establish the link to a wallet-based
												community that can support the journalist as they
												create more content.
											</Typography>
										</CardContent>
										<CardMedia
									...
									<Card sx={{ maxWidth: 600, height: 450 }}>
										<CardContent>
											<Typography
												...
												color="#01A0B0"
											>
												Support for journalists: Funding pools and bonus
												payments
											</Typography>
											<Typography variant="body2" color="text.secondary">
												Funding pools and bonus payments: Funding pools
												allow the community to direct tokens to commission
												topics they want journalists to photograph and write
												about and for journalists to raise funds for
												initiatives they want to report on. Refound also
												offers the ability for users to support journalists
												in areas affected by war and conflict by sending
												them a bonus payment when viewing their content.
											</Typography>
										</CardContent>
										<CardMedia
											component="img"
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 400 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												which allows journalists in a geographically focused
												conflict zone to communicate with each other and
												send verified alerts of any escalating danger or
												risk in the area they are in, with alerts posting on
												a decentralized ledger(To be developed in next
												phase).
											</Typography>
										</CardContent>
										<CardMedia
								...
								<Grid item sm={12} md={6} style={{ padding: "3%" }}>
									<Card sx={{ maxWidth: 600, height: 400 }}>
										<CardContent>
											...
											<Typography variant="body2" color="text.secondary">
												With blockchain technology, information about
												identity is linked to a wallet, and journalists can
												choose to remain anonymous if needed. Individuals
												can also curate their own profiles and control the
												level of data and identity. Refound offers the
												ability for journalists to verify their profiles
												with press ID card or journalism credentials if they
												choose to as well.
											</Typography>
										</CardContent>
										<CardMedia
