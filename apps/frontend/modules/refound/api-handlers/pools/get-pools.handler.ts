...
export async function getPoolsHandler(req: NextApiRequest, res: NextApiResponse<PoolAggregate[]>) {
	...
	return (await queries.getPools(coreContract, poolContract)).match({
		ok: (pool) => {
