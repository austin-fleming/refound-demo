...
export async function getLicensesByAccountHandler(
	req: NextApiRequest,
	res: NextApiResponse<LicenseAggregate[]>,
) {
	...
	return (await queries.getLicensesByAddress(postContract, accountAddress)).match({
		ok: (licenses) => {
